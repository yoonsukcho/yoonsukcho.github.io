...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        __WEBPACK_IMPORTED_MODULE_1_firebase__["initializeApp"]({
            apiKey: "AIzaSyA-GPYbVErNBONpB5aIaijoM5_1F8ZC_P4",
            authDomain: "angular-test-580b6.firebaseapp.com"
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__auth_signup_signup_component__ = __webpack_require__("../../../../../src/app/auth/signup/signup.component.ts");
...
var DataStorageService = (function () {
    ...
    DataStorageService.prototype.storeRecipes = function () {
        ...
        return this.http.put('https://angular-test-580b6.firebaseio.com/recipes.json?auth=' + token, this.recipeService.getRecipes());
    };
    DataStorageService.prototype.getRecipes = function () {
        var _this = this;
        var token = this.authService.getToken();
        this.http.get('https://angular-test-580b6.firebaseio.com/recipes.json?auth=' + token)
